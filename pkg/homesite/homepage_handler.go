...
var homepage spaHandler

func ConnectToRouter(r *mux.Router, route, staticPath, indexPath string) {
	homepage.indexPath = indexPath
	homepage.staticPath = staticPath

	r.PathPrefix(route).Handler(homepage)
}
